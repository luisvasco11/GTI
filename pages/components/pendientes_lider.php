...
$query="SELECT DISTINCT categoria FROM `actividad`";
$rep=$wish->conexion->query($query);


$query="SELECT DISTINCT plataforma FROM `actividad`";
    ...
    if($consulta = $wish->conexion->query($consulta))
    {
        ...
        {?>
                                            <tr>
                                                ...
                                                <td><a><input onclick="aprobar(<?php printf($obj->id);?>)" type="image" src="dist/img/checkmark.svg"></a></td>
                                                <td><a ><input onclick="desaprobar(<?php printf($obj->id);?>)" type="image" src="dist/img/cross.svg"></a></td>
