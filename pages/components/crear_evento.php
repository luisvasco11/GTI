...
$queryContratos = "select * from proyecto";
$rContratos = $wish->conexion->query ( $queryContratos );

$queryContratos = "select * from proyecto where estado='A' and grupo=1";
$rContratosimp = $wish->conexion->query ( $queryContratos );
...
while ( $row = $rContratos->fetch_object () ) {
                    ...
                    <option id="<?php echo $row->id; ?>"
									value="<?php echo $row->id; ?>"><?php echo $row->proyecto;?></option>
                    <?php } ?>  
                </select>
						</div>
